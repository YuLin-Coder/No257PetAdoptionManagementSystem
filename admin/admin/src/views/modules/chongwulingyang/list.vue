		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"width":"95%","margin":"40px 0 20px 5%"}' :inline="true" :model="searchForm">
				<el-row :style='{"display":"block"}' >
					...
					<div :style='{"margin":"0 20px 0 0","display":"inline-block"}'>
						...
						<el-input v-model="searchForm.chongwufenlei" placeholder="宠物分类" clearable></el-input>
					</div>
				...
				<el-row :style='{"margin":"20px 0","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#333","borderRadius":"4px","background":"linear-gradient(180deg, #DDE2FC 0%, #FCF6E5 100%)","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('chongwulingyang','新增')" type="success" @click="addOrUpdateHandler()">新增</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#333","borderRadius":"4px","background":"linear-gradient(180deg, #DDE2FC 0%, #FCF6E5 100%)","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('chongwulingyang','删除')" :disabled="dataListSelections.length <= 0" type="danger" @click="deleteHandler()">删除</el-button>
			...
			<!-- <div> -->
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='false'  
						prop="lingyangshenqing"
					label="领养申请">
						<template slot-scope="scope">
							{{scope.row.lingyangshenqing}}
						</template>
					</el-table-column>
					<el-table-column :resizable='true' :sortable='false'  
						prop="shenqingbeizhu"
					...
					<el-table-column :resizable='true' :sortable='false' v-if="isAuth('chongwulingyang','审核')" prop="sfsh" label="审核">
						<template slot-scope="scope">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 5px 0","outline":"none","color":"#fff","borderRadius":"30px","background":"rgba(217, 217, 217, 1)","width":"auto","fontSize":"14px","height":"32px"}' v-if=" isAuth('chongwulingyang','查看')" type="success" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">详情</el-button>
							<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 5px 0","outline":"none","color":"#fff","borderRadius":"30px","background":"rgba(217, 217, 217, 1)","width":"auto","fontSize":"14px","height":"32px"}' v-if=" isAuth('chongwulingyang','修改')" type="primary" size="mini" @click="addOrUpdateHandler(scope.row.id)">修改</el-button>





							<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 5px 0","outline":"none","color":"#fff","borderRadius":"30px","background":"rgba(217, 217, 217, 1)","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('chongwulingyang','删除') " type="danger" size="mini" @click="deleteHandler(scope.row.id)">删除</el-button>
						</template>
					</el-table-column>
				</el-table>
				<el-pagination
    ...
    shDialog(row){
      ...
      if(row){
        this.shForm = {
          ...
          chongwufenlei: row.chongwufenlei,
          chongwutupian: row.chongwutupian,
          chongwuxingbie: row.chongwuxingbie,
          jiezhongyimiao: row.jiezhongyimiao,
          chongwuxingqing: row.chongwuxingqing,
          chongwuxiangqing: row.chongwuxiangqing,
          lingyangyaoqiu: row.lingyangyaoqiu,
          beizhu: row.beizhu,
          faburiqi: row.faburiqi,
          lingyangshenqing: row.lingyangshenqing,
          shenqingbeizhu: row.shenqingbeizhu,
