    ...
    >
          ...
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"none"}' label="接种疫苗" prop="jiezhongyimiao">
            <el-input v-model="ruleForm.jiezhongyimiao" 
                placeholder="接种疫苗" clearable ></el-input>
          </el-form-item>
          ...
          <!-- <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"none"}' label="领养要求" prop="lingyangyaoqiu">
            <el-input v-model="ruleForm.lingyangyaoqiu" 
                placeholder="领养要求" clearable ></el-input>
          </el-form-item> -->
          <!-- <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"none"}' label="备注" prop="beizhu">
          ...
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"none"}' label="发布日期" prop="faburiqi">
            <el-input v-model="ruleForm.faburiqi" 
                placeholder="发布日期" clearable ></el-input>
          </el-form-item>
          <!-- <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"none"}' label="领养申请" prop="lingyangshenqing">
            <el-input v-model="ruleForm.lingyangshenqing" 
                placeholder="领养申请" clearable ></el-input>
          </el-form-item> -->
          <!-- <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"none"}' label="申请备注" prop="shenqingbeizhu">
            <el-input v-model="ruleForm.shenqingbeizhu" 
                placeholder="申请备注" clearable ></el-input>
          </el-form-item> -->
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"none"}' label="申请日期" prop="shenqingriqi" >
              <el-date-picker
...
<script>
  export default {
    ...
    // 多级联动参数
      // 多级联动参数
      info(id) {
        this.$http.get('chongwulingyang/detail/${id}', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
                  ...
                  params: params
                     ...
                     if(res.data.data.total>=crossoptnum) {
                         ...
                         // 跨表计算
                          ...
                          this.$http.post('chongwulingyang/add', this.ruleForm).then(res => {
                              if (res.data.code == 0) {
                                  this.$message({
                                      message: '操作成功',
                                      type: 'success',
